...
import estilos from '@/app/ui/home.module.css';
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          ...
          <h3 className={estilos.subtitulo}>
            Neutrino Sistema Escolar
          </h3>
          <p className={`text-xl text-gray-800 md:text-3xl md:leading-normal antialiased`}>
            <strong>Bienvenido a Neutrino Sistema Escolar.</strong> La información de su unidad académica, en la palma de su mano.
          </p>
          <Link
            href="/login"
